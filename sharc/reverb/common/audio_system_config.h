...
#define FAUST_INSTALLED                               FALSE
     ...
     * and do audio processing.  Presently, an Audio Project Fin is required as 
	 * the Faust algorithm is configured to generate a synth sound based on MIDI 
	 * notes.
     ...
     * normal.
     */
    #define USE_FAUST_ALGORITHM_CORE1                 FALSE
