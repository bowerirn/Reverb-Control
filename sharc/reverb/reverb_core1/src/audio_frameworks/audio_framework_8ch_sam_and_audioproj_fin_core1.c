...
#pragma section("seg_l1_block1_bsz_data", ZERO_INIT)
int sport0_dma_rx_1_buffer[AUDIO_CHANNELS * AUDIO_BLOCK_SIZE];
#pragma section("seg_l1_block1_bsz_data", ZERO_INIT)
int sport0_dma_tx_0_buffer[AUDIO_CHANNELS * AUDIO_BLOCK_SIZE];
#pragma section("seg_l1_block1_bsz_data", ZERO_INIT)
int sport0_dma_tx_1_buffer[AUDIO_CHANNELS * AUDIO_BLOCK_SIZE];

// A2B Fixed-point (raw ADC/DAC data) DMA buffers for ping-pong / double-buffered DMA
#pragma section("seg_l1_block1_bsz_data", ZERO_INIT)
int sport1_dma_rx_0_buffer[AUDIO_CHANNELS * AUDIO_BLOCK_SIZE];
#pragma section("seg_l1_block1_bsz_data", ZERO_INIT)
int sport1_dma_rx_1_buffer[AUDIO_CHANNELS * AUDIO_BLOCK_SIZE];
#pragma section("seg_l1_block1_bsz_data", ZERO_INIT)
int sport1_dma_tx_0_buffer[AUDIO_CHANNELS * AUDIO_BLOCK_SIZE];
#pragma section("seg_l1_block1_bsz_data", ZERO_INIT)
int sport1_dma_tx_1_buffer[AUDIO_CHANNELS * AUDIO_BLOCK_SIZE];

// SPDIF Fixed-point (raw ADC/DAC data) DMA buffers for ping-pong / double-buffered DMA
#pragma section("seg_l1_block1_bsz_data", ZERO_INIT)
int sport2_dma_rx_0_buffer[SPDIF_DMA_CHANNELS * AUDIO_BLOCK_SIZE];
#pragma section("seg_l1_block1_bsz_data", ZERO_INIT)
int sport2_dma_rx_1_buffer[SPDIF_DMA_CHANNELS * AUDIO_BLOCK_SIZE];
#pragma section("seg_l1_block1_bsz_data", ZERO_INIT)
