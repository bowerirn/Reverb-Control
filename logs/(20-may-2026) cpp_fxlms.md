...
### Next Steps
- First I need to make sure everything can compile on windows. 
- Next, I want to try setting up Python to directly interface with ASIO. 
...
- Lastly, I need to make a way to generate sine sweeps and measure IRs, ideally with latency compensation.